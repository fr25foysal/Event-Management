      ...
      <div className= "grid justify-center mt-10">
        <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
          ...
          <form className="mt-4 mb-2 w-80 max-w-screen-lg sm:w-96">
            ...
            <button
              className="mt-6 block w-full select-none rounded-lg bg-gray-700 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-700/20 transition-all hover:shadow-lg hover:shadow-gray-700/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
              type="button"
            ...
            <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
              ...
              <Link
                className="font-medium ml-1 text-gray-700 transition-colors hover:text-blue-700"
                to={'/login'}
              >
               Sign In
              </Link>
